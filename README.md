...
- Criar uma classe Playlist, com os atributos nome e uma lista.
- Criar método para adicionar audio na Playlist e outro método para Listar Audios da Playlist.
- Instanciar um objeto do tipo Playlist e utilizar seus método.
